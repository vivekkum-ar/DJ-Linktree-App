        ...
        <div className="md:py-8 py-1 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
          ...
          <form className="w-full max-w-md mx-auto">   
            ...
            <div className="relative">
              ...
              <input type="email" id="default-email" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-500" placeholder="Enter your email here..." required />
